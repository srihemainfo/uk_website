...
@section('content')
    ...
    <div id="mobileActionBar">
        {{-- <a href="tel:+442083373777" class="mob-action-btn">
        ...
        <a href="https://api.whatsapp.com/send/?phone=447922608080&text=Hi%2C%20I%20need%20a%20cab.%20Could%20you%20help%20me%20book%20one%3F&type=phone_number&app_absent=0" target="_blank" class="mob-action-btn">
            <div class="mob-action-icon">
                <i class="fab fa-whatsapp"></i>
            </div>
            <span>WhatsApp</span>
        ...
        <div class="modal-dialog" role="document"
            ...
            <div class="modal-content" style="border: none;">
                ...
                <div style="display: flex; gap: 12px; justify-content: center;">
                    <button type="button" id="btnConfirmCancelJob" onclick="confirmCancelJob(this)"
    ...
    <script>
        ...
        function evaluateRefundEligibility(dateVal, timeVal, offsetMinutes = 0) {
            try {
                ...
                if (!year || !month || !day) {
                    console.warn('[RefundCheck] Could not parse date:', dateVal, timeVal);
                    return false;
                }

                // Scheduled pickup in Europe/London time as UTC representation
                let pickupUtcMs = Date.UTC(year, month - 1, day, hours, minutes);
                if (offsetMinutes && !isNaN(offsetMinutes)) {
                    pickupUtcMs += parseInt(offsetMinutes, 10) * 60 * 1000;
                }
                ...
                console.log('[RefundCheck] Pickup London:', `${year}-${month}-${day} ${hours}:${minutes}`, '| Now London:', `${lp.year}-${lp.month}-${lp.day} ${lp.hour}:${lp.minute}`, '| diffMinutes:', diffMinutes);

                return diffMinutes >= 60;
            } catch (e) {
                console.warn('[RefundCheck] Error checking refund eligibility:', e);
                return false;
            }
        }
